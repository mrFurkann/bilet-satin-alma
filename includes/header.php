...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm">
    <div class="container">
        <a class="navbar-brand" href="<?= DEFAULT_PATH ?>/index.php">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link" href="<?= DEFAULT_PATH ?>/index.php">
                ...
                <?php if ($is_logged_in): ?>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            <li>
                                <a class="dropdown-item" href="<?= DEFAULT_PATH ?>/user/hesap.php">
                                    <i class="bi bi-wallet me-2"></i> Hesabım / Bakiye (<?= number_format($current_user['balance'] ?? 0, 2, ',', '.') ?> ₺)
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?= DEFAULT_PATH ?>/user/biletler.php">
                                    <i class="bi bi-ticket-detailed me-2"></i> Biletlerim
                                </a>
                            </li>
                            <li><hr class="dropdown-divider"></li>
                            <li>
                                <a class="dropdown-item text-danger" href="<?= DEFAULT_PATH ?>/logout.php">
